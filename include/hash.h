...
extern Hash_Entry* Hash_CreateEntry(
    Hash_Table* tablePtr, Address key, Boolean* newPtr);
extern void Hash_DeleteTable(Hash_Table* tablePtr);
extern void Hash_DeleteEntry(Hash_Table* tablePtr, Hash_Entry* hashEntryPtr);
extern Hash_Entry* Hash_EnumFirst(Hash_Table* tablePtr, Hash_Search* searchPtr);
...
extern void Hash_PrintStats(
    Hash_Table* tablePtr, void (*proc)(Opaque data, char* msg), Opaque data);
