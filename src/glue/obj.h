 ...
 */
extern VMHandle Obj_Open(
    const char* file, short* statusPtr, ObjFileType* typePtr, int justChecking);
...
extern SegDesc* Obj_FindFrameVM(const char* file, /* File name (for PRIVATE
    ...
    word offset); /* Offset of descriptor w/in header
                   * block */
extern void Obj_PrintType(FILE* stream, VMHandle file, void* base, word type);
...
extern int Obj_EnterTypeSyms(const char* file, /* File name */
    ...
    int flags);                                /* TRUE to enter all
                                                ...
                                                * symbols (i.e. not
                                                * structure fields) */
#define OETS_TOP_LEVEL_ONLY                  \
    0x0001 /* Enter top-level symbols only;  \
            * this doesn't include structure \
            * fields */
#define OETS_RETAIN_ORIGINAL           \
    0x0002 /* Retain all the memory in \
...
#define Obj_CheckRelated(s1, s2)                                           \
    ((((((SegDesc*)(s1))->type == S_SEGMENT) ||                            \
        ...
        (((SegDesc*)(s2))->type != S_GROUP && ((SegDesc*)(s2))->group &&   \
            (((SegDesc*)(s2))->group->name == ((SegDesc*)(s1))->name)) ||  \
        ((((SegDesc*)(s1))->type != S_GROUP) && ((SegDesc*)(s1))->group && \
