...
/* Command-line: gperf -i8 -o -j1 -S 1 -DtlTC -k1-3,$ -N findOpcode -H
 * hashOpcode opcodes.gperf  */
...
{
    static const unsigned short asso_values[] = {444,
        444,
        444,
        444,
        444,
...
register unsigned int len;
{
    static const unsigned char lengthtable[] = {3,
        3,
        3,
        3,
        4,
