...
extern void Code_Prologue(
    int frameNeeded, dword usesMask, int localSize, int fpSaved);

extern FixResult Code_Fxch(
...
extern void Code_Epilogue(int frameNeeded, int usesMask, int localSize);
