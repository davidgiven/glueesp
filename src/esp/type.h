...
extern TypePtr Type_Int(int size), Type_Char(int size),
    Type_Array(int len, TypePtr base), Type_Signed(int size),
    Type_Struct(SymbolPtr t), Type_Ptr(char pType, TypePtr base);
