...
/* Command-line: gperf -i1 -o -j1 -S 1 -DtlTC -k1-4,6,8,$ -N findKeyword -H
 * hashKeyword keywords.gperf  */
...
{
    static const unsigned short asso_values[] = {497,
        497,
        497,
        497,
        497,
...
register unsigned int len;
{
    static const unsigned char lengthtable[] = {1,
        1,
        2,
        2,
        2,
    ...
    static const OpCode wordlist[] = {
        ...
        {
         ".386", PROCESSOR,
         PROC_80386 | PROC_80286 | PROC_80186 | PROC_8086,
         },
        {
         ".387", COPROCESSOR,
         PROC_80387, },
        ...
        {
         ".286", PROCESSOR,
         PROC_80286 | PROC_80186 | PROC_8086,
         },
        {
         "sizestr", SIZESTR,
         0, },
        ...
        {
         ".386p", PROCESSOR,
         PROC_80386 | PROC_PROT | PROC_80286 | PROC_80186 | PROC_8086,
         },
        {
         "global", GLOBAL,
         0, },
        ...
        {
         ".286p", PROCESSOR,
         PROC_PROT | PROC_80286 | PROC_80186 | PROC_8086,
         },
        {
         ".break", BREAK,
         0, },
