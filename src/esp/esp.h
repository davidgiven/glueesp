...
extern void NotifyInt(NotifyType, ID file, int line, char* fmt, va_list args);
...
extern void LMem_InitSegment(
    SymbolPtr group, word segType, word flags, word freeSpace);
