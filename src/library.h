...
extern ID Library_TackPrependPublishedToID(
...
extern void Library_Publish(VMHandle fh,
    VMBlockHandle dataBlock,
    VMBlockHandle relBlock,
    word procOffset,
    word bytes,
    ID symID);
...
extern LibraryLinkValues Library_Link(
    char* name, LibraryLoadTypes loadType, word attrs);
