 ...
 *
 ***********************************************************************/
static int FontPrepare(char* outfile, char* paramfile, char* mapfile)
{
    int cbase;
    int i;
 ...
 *
 ***********************************************************************/
static int FontReloc(int type, /* Relocation type (from obj file) */
 ...
 *
 ***********************************************************************/
static void FontWrite(void* base, /* Base of file buffer */
 ...
 *
 ***********************************************************************/
static int FontCheckFixed(SegDesc* targ)
{
