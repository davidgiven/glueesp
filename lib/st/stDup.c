 ...
 *
 ***********************************************************************/
ID ST_Dup(VMHandle vmSrcHandle,
    ID srcID,
    ...
    VMBlockHandle dstTable)
{
     ...
     */
    stcp =
        (STChainPtr)((char*)VMLock(vmSrcHandle, srcID >> 16, (MemHandle*)NULL) +
    ...
    result = STSearch(
        vmDstHandle, hdr, bucket, stcp->hashval, stcp->string, stcp->length);
 ...
 *
 ***********************************************************************/
ID ST_DupNoEnter(VMHandle vmSrcHandle,
    ID srcID,
    VMHandle vmDstHandle,
    VMBlockHandle dstTable)
{
