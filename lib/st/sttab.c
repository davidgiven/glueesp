...
#define ELTS_PER_CHUNK                    \
    128 /* Number of HashElts to allocate \
         * at a time */
 ...
 *
 ***********************************************************************/
static int StringHash(char* string, int length)
{
    char* cp;
    unsigned hash;
 ...
 *
 ***********************************************************************/
ID String_Enter(char* string, int length)
{
    int bucket;
    HashElt* hep;
 ...
 *
 ***********************************************************************/
ID String_Lookup(char* string, int length)
{
    int bucket;
    HashElt* hep;
 ...
 *
 ***********************************************************************/
ID String_LookupNoLen(char* str)
{
