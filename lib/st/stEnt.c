 ...
 *
 ***********************************************************************/
ID STAlloc(VMHandle vmHandle, /* Handle of file containing table */
    ...
    int len)                  /* Length of same */
{
    ...
    {
        hdr->chains[bucket] =
            VMAlloc(vmHandle, ST_INIT_CHAIN_BYTES, ST_CHAIN_ID);
        /*
 ...
 *
 ***********************************************************************/
ID ST_Enter(VMHandle vmHandle, /* File in which table resides */
