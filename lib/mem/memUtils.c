 ...
 *
 ***********************************************************************/
volatile void MemAllocErr(void)
{
...
MemHandle MemAllocHandle()
{
    ...
    if (memHandleFreeList < 0)
    {
        ...
        if (memNumHandles == 0)
        {
             ...
             */
            memHandleTable = (MemHandlePtr)malloc(
                MEM_INIT_NUM_HANDLES * sizeof(MemHandleRec));
        ...
        else
        {
            ...
            memHandleTable = (MemHandlePtr)realloc(
                (char*)memHandleTable, memNumHandles * sizeof(MemHandleRec));
        }
        /*
 ...
 *
 ***********************************************************************/
void MemFreeHandle(MemHandle handle)
{
