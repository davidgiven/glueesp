 ...
 ***********************************************************************/
#ifndef lint
static char* rcsid = "$Id: vmAttr.c,v 1.3 92/12/10 22:08:46 adam Exp $";
#endif lint
 ...
 *
 ***********************************************************************/
byte VMGetAttributes(VMHandle vmHandle)
{
 ...
 *
 ***********************************************************************/
void VMSetAttributes(VMHandle vmHandle,
 ...
 *
 ***********************************************************************/
void VMSetLMemFlag(VMHandle vmHandle, VMBlockHandle vmBlock)
{
    VMBlock* block;
 ...
 *
 ***********************************************************************/
void VMSetPreserveFlag(VMHandle vmHandle, VMBlockHandle vmBlock)
{
    VMBlock* block;
