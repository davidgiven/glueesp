 ...
 *
 ***********************************************************************/
void VMSetMapBlock(VMHandle vmHandle, /* VM File */
 ...
 *
 ***********************************************************************/
VMBlockHandle VMGetMapBlock(VMHandle vmHandle)
{
 ...
 *
 ***********************************************************************/
void VMSetDBMap(VMHandle vmHandle, /* VM File */
    VMBlockHandle vmBlock)         /* Block to be map block */
{
    VMFilePtr file; /* Internal representation of vmHandle */
    VMHeader* hdr;  /* Header block for vmHandle */
 ...
 *
 ***********************************************************************/
VMBlockHandle VMGetDBMap(VMHandle vmHandle)
{
    VMFilePtr file = (VMFilePtr)vmHandle;
